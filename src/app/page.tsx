    ...
    <div className="flex-1 w-full flex flex-col gap-20 items-center">
      <nav className="w-full flex justify-center border-b border-b-foreground/10 h-16 px-2 md:px-0">
        <div className="w-full max-w-screen-lg flex justify-between items-center p-3 text-sm">
          <h1 className="text-3xl font-bold text-primary">CODING CHALLENGE</h1>
      ...
      <main className="container">
        ...
        <div className="mt-8">
          <h2 className="font-bold text-3xl mb-4">Next steps</h2>
          ...
          <h2 className="font-bold text-3xl mb-4 mt-8">Resources</h2>
